...
public class Config {
	...
	private final long  modRoleId, canBanRoldId, canKickRoleId, 
						warningRoleId, muteRoleId, logChannelId, serverId;
	...
	public IRole getModRole() { return discord.getRoleByID(modRoleId); }
	public IRole getCanBanRole() { return discord.getRoleByID(canBanRoldId); }
	public IRole getCanKickRole() { return discord.getRoleByID(canKickRoleId); }
	public IRole getWarningRole() { return discord.getRoleByID(warningRoleId); }
	public IRole getMuteRole() { return discord.getRoleByID(muteRoleId); }
	public IChannel getLogChannel() { return discord.getChannelByID(logChannelId); }
	public IGuild getServer() { return discord.getGuildByID(serverId); }
